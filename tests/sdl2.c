...
int main(int argc, char **argv) {
  ...
  sfb_colour bg = {0, 0, 0, 255};
  sfb_colour cube = {255, 255, 255, 255};

  sfb_framebuffer *fb = sfb_create_framebuffer(300, 300, SFB_BLEND_ENABLED);
  sfb_obj *obj = sfb_create_rect(0, 0, 25, 25, cube, fb->channels);
