...
int main(void){
  ...
  sprite->pixels = sfb_scale_nearest_topleft_malloc(sprite->pixels, &sprite->w, &sprite->h, 1);
  sfb_write_obj_rect(sprite, fb);
  sfb_image_write_png(sprite->w, sprite->h, sprite->pixels, 4, "sprite_scaled.png");
